...
const { getProducts, getProduct, photoProduct, relatedProducts, filterProducts, postProduct, updateProduct, deleteProduct } = require('../controllers/productController');
...
router.get('/photo/:number/:productId', photoProduct);
